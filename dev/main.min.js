...
if (isMobile) {
  ...
  $("body").swipe({
    swipe: function (event, direction) {
      ...
      scrollToSectio(scrollDirection);
    }
  });
...
$('.player__progress--video').on('click', (e) => {
  ...
  let buttonPositionPercent = (newButtonPosition/bar.width()) * 100;
  if (buttonPositionPercent > 100) buttonPositionPercent = 100;
...
$('.player__progress--sound').on('click', (e) => {
  const bar = $(e.currentTarget);
  const newButtonPosition = e.pageX - bar.offset().left;
  let buttonPosition = (newButtonPosition/bar.width());
  if (buttonPosition > 1) buttonPosition= 1;
  video[0].volume = buttonPosition;
  let buttonPositionPercent = (newButtonPosition/bar.width())*100;
  if (buttonPositionPercent > 100) buttonPositionPercent = 100;

  $('.player__scrollbutton--sound').css({
    left: `${buttonPositionPercent}%`
  })
